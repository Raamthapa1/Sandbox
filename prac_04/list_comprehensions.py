...
# Making a  list comprehension to create a list of all the full_names in lowercase format
lowercase_full_names =[name.lower() for name in full_names]
print(lowercase_full_names)

almost_numbers = ['0', '10', '21', '3', '-7', '88', '9']
# Making a  list comprehension to create a list of integers from the above list of strings
numbers = [int(almost_number) for almost_number in almost_numbers]
print(numbers)


# Making a list comprehension to create a list of only the numbers that are
# greater than 9 from the numbers (not strings) you just created
greater_number = [number for number in numbers if number > 9]
print(greater_number)

# Making use of list comprehension and the join string method
...
long_last_names = [long_name.split()[1][0:] for long_name in long_names]
